...
public class Produccion implements Serializable {
	...
	private List<ProduccionPlanta> detallePlanta;
	...
	public List<ProduccionPlanta> getDetallePlanta() {
		return detallePlanta;
	}

	public void setDetallePlanta(List<ProduccionPlanta> detallePlanta) {
		this.detallePlanta = detallePlanta;
	}
